...
* 2525-09-28 오후 1:19 // 18.00 릴리스, 할일 처리 방법론 LunaFlowACT (기존 방법론 취사 선택해서 제미나이 2.5 프로로 합쳐봤습니다.) 문서를 추가,  관련된 폴더 Inbox, Today, A1 (Must Have), B2 (Should Have), C3 (Could Have) 5개를 기본값 폴더에 추가,  고정글 포커싱 시 글 목록에서 글 배경색 바뀌지 않는 문제 수정
