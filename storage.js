...
---
 ...
 6. 💾 소중한 기록을 위한 저장 공간 안내 (매우 중요!)

MothNote는 여러분의 모든 생각을 빠르고 안전하게 기록할 수 있도록 설계되었습니다. 현재 브라우저 확장 프로그램의 기술적인 제약으로 인해, 전체 저장 공간은 약 5MB로 제한되어 있습니다.

"5MB가 어느 정도인가요?" 하고 궁금하실 텐데요, 텍스트 데이터로는 생각보다 아주 큰 공간이랍니다!

*   200자 원고지 약 12,500장 분량
*   단편 소설(약 50페이지) 20~25권 분량
*   아서 코난 도일의 『셜록 홈즈』 시리즈 전집을 모두 담을 수 있는 분량

대부분의 사용자에게는 충분한 공간이지만, 이미지를 텍스트로 변환하여 저장하거나 매우 긴 기록을 꾸준히 작성하신다면 언젠가 한계에 도달할 수 있습니다.

따라서 주기적으로 데이터를 '내보내기'하여 백업하시는 것을 강력히 권장합니다. 만약 공간이 부족하다는 알림을 받게 되면, 더 이상 중요하지 않은 노트들을 휴지통으로 옮긴 뒤 '휴지통 비우기'를 통해 공간을 확보할 수 있습니다.

앞으로 더 많은 데이터를 불편 없이 저장하실 수 있도록, 브라우저의 더 강력한 저장소 기술(IndexedDB)로 업그레이드하는 방안을 적극적으로 검토하고 있습니다. 여러분의 소중한 기록이 안전하게 보관될 수 있도록 항상 최선을 다하겠습니다.`, 
                createdAt: now, 
                updatedAt: now, 
                isPinned: false 
            };
