...
1. 🚀 MothNote 핵심 기능 알아보기
  ...
  🦋 올인원 대시보드:
  새 탭을 열 때마다 시계, 현재 날씨, 그리고 똑똑한 달력을 바로 확인할 수 있습니다.
    - 🌦️ 상세 날씨 정보: 대시보드의 [날씨 아이콘]이나 [온도]를 클릭해 보세요! 주간 예보, 시간별 기온 변화 등 상세한 날씨 정보를 담은 특별 페이지가 열립니다. 각 날짜 카드를 클릭하면 그날의 시간대별 예보도 확인할 수 있답니다.
    - 📅 클릭 가능한 달력: 달력에서 노트가 작성된 날짜는 밑줄로 표시됩니다. 날짜를 클릭하면 해당 일자에 작성된 모든 노트를 바로 모아볼 수 있어요. 달력의 '년/월'을 클릭하면 다른 날짜로 점프할 수도 있습니다.
