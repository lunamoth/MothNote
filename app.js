...
import { 
    ...
    updateAndSaveState, // [MODIFIED] performTransactionalUpdate -> updateAndSaveState
    performDeleteItem,
} from './itemActions.js';
import { 
...
// [REMOVED] 탭 ID 생성 및 전역 변수 할당 로직 삭제
